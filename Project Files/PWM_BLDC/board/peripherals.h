...
/* FTM0_SYNC: TRIG2=0, TRIG1=0, TRIG0=0, SYNCHOM=1, REINIT=0, CNTMAX=1, CNTMIN=0 */
#define FTM0_SYNC_INIT 0xAU
...
/* FTM0_SYNCONF: HWSOC=0, HWINVC=0, HWOM=0, HWWRBUF=0, HWRSTCNT=0, SWSOC=1, SWINVC=0, SWOM=1, SWWRBUF=1, SWRSTCNT=1, SYNCMODE=1, SWOC=1, INVC=1, CNTINC=1, HWTRIGMODE=0 */
#define FTM0_SYNCONF_INIT 0x17B4U
