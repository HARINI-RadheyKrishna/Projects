...
/* FTM0_SC: TOIE=1, CPWMS=0, CLKS=1, PS=0 */
#define FTM0_SC_INIT 0x48U
/* FTM0_MOD: MOD=5999 */
...
/* FTM0_SYNC: TRIG2=0, TRIG1=0, TRIG0=0, SYNCHOM=1, REINIT=1, CNTMAX=1, CNTMIN=1 */
#define FTM0_SYNC_INIT 0xFU
...
/* FTM0_CONF: GTBEOUT=0, GTBEEN=1, BDMMODE=0, NUMTOF=31 */
#define FTM0_CONF_INIT 0x21FU
