...
- {pin_num: '99', pin_signal: ADC0_SE7b/PTD6/LLWU_P15/SPI0_PCS3/UART0_RX/FTM0_CH6/FB_AD0/FTM0_FLT0/SPI1_SOUT, label: 'J2[6]/SPI0_PCS3/FTM0_CH6', identifier: FTM0_CH6}
...
- pin_list:
  - {pin_num: '36', peripheral: TPIU, signal: SWO, pin_signal: PTA2/UART0_TX/FTM0_CH7/CMP1_OUT/FTM2_QD_PHB/FTM1_CH0/JTAG_TDO/TRACE_SWO/EZP_DO, pull_select: down,
    pull_enable: disable}
  - {pin_num: '31', peripheral: FTM0, signal: 'CH, 0', pin_signal: ADC0_SE17/PTE24/FTM0_CH0/I2C0_SCL/EWM_OUT_b, direction: OUTPUT}
  ...
  - {pin_num: '39', peripheral: FTM0, signal: 'CH, 2', pin_signal: PTA5/FTM0_CH2/JTAG_TRST_b, direction: OUTPUT}
  ...
  - {pin_num: '99', peripheral: FTM0, signal: 'CH, 6', pin_signal: ADC0_SE7b/PTD6/LLWU_P15/SPI0_PCS3/UART0_RX/FTM0_CH6/FB_AD0/FTM0_FLT0/SPI1_SOUT, direction: OUTPUT}
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t ADC0_SE9_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB1 (pin 54)  */
    GPIO_PinInit(BOARD_ADC0_SE9_GPIO, BOARD_ADC0_SE9_PIN, &ADC0_SE9_config);
    ...
    gpio_pin_config_t ADC1_SE14_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    ...
    PORT_SetPinMux(BOARD_FTM0_CH2_PORT, BOARD_FTM0_CH2_PIN, kPORT_MuxAlt3);

    /* PORTB1 (pin 54) is configured as PTB1 */
    PORT_SetPinMux(BOARD_ADC0_SE9_PORT, BOARD_ADC0_SE9_PIN, kPORT_MuxAsGpio);
    ...
    PORT_SetPinMux(BOARD_FTM0_CH5_PORT, BOARD_FTM0_CH5_PIN, kPORT_MuxAlt4);

    /* PORTD6 (pin 99) is configured as FTM0_CH6 */
    PORT_SetPinMux(BOARD_FTM0_CH6_PORT, BOARD_FTM0_CH6_PIN, kPORT_MuxAlt4);

    /* PORTE24 (pin 31) is configured as FTM0_CH0 */
    PORT_SetPinMux(BOARD_FTM0_CH0_PORT, BOARD_FTM0_CH0_PIN, kPORT_MuxAlt3);
}
