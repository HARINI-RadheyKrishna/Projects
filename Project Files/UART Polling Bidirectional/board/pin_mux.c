...
- {pin_num: '95', pin_signal: PTD2/LLWU_P13/SPI0_SOUT/UART2_RX/FTM3_CH2/FB_AD4/LPUART0_RX/I2C0_SCL, label: 'U8[4]/I2C0_SCL', identifier: ACCEL_SCL;UART2_CH2;UART2_RX}
...
- pin_list:
  ...
  - {pin_num: '10', peripheral: UART2, signal: TX, pin_signal: ADC0_SE4a/PTE16/SPI0_PCS0/UART2_TX/FTM_CLKIN0/FTM0_FLT3}
...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_SPI0_PCS0_PORT, BOARD_SPI0_PCS0_PIN, kPORT_MuxAlt3);

    /* PORTE17 (pin 11) is configured as UART2_RX */
    PORT_SetPinMux(BOARD_SPI0_SCK_PORT, BOARD_SPI0_SCK_PIN, kPORT_MuxAlt3);
