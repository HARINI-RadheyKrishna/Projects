...
/* Symbols to be used with PORT driver */
#define BOARD_UART1_TX_PORT PORTE               /*!<@brief PORT peripheral base pointer */
#define BOARD_UART1_TX_PIN 0U                   /*!<@brief PORT pin number */
#define BOARD_UART1_TX_PIN_MASK (1U << 0U)      /*!<@brief PORT pin mask */
                                                /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_UART1_RX_PORT PORTE               /*!<@brief PORT peripheral base pointer */
#define BOARD_UART1_RX_PIN 1U                   /*!<@brief PORT pin number */
#define BOARD_UART1_RX_PIN_MASK (1U << 1U)      /*!<@brief PORT pin mask */
                                                /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_SPI0_PCS0_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_SPI0_PCS0_PIN 16U                   /*!<@brief PORT pin number */
#define BOARD_SPI0_PCS0_PIN_MASK (1U << 16U)      /*!<@brief PORT pin mask */
                                                  /* @} */
...
/* Symbols to be used with PORT driver */
#define BOARD_SPI0_SCK_PORT PORTE                /*!<@brief PORT peripheral base pointer */
#define BOARD_SPI0_SCK_PIN 17U                   /*!<@brief PORT pin number */
#define BOARD_SPI0_SCK_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                                 /* @} */
